...
(
    ...
    "rowguid"          uuid      NOT NULL
        CONSTRAINT "DF_BusinessEntity_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_BusinessEntity_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "NameStyle"             "NameStyle" NOT NULL
        CONSTRAINT "DF_Person_NameStyle"      DEFAULT (false),
    ...
    "EmailPromotion"        INT         NOT NULL
        CONSTRAINT "DF_Person_EmailPromotion" DEFAULT (0),
    ...
    "rowguid"               uuid        NOT NULL
        CONSTRAINT "DF_Person_rowguid"        DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"          TIMESTAMP   NOT NULL
        CONSTRAINT "DF_Person_ModifiedDate"   DEFAULT (NOW()),
    CONSTRAINT "CK_Person_EmailPromotion" CHECK ("EmailPromotion" BETWEEN 0 AND 2),
    CONSTRAINT "CK_Person_PersonType" CHECK ("PersonType" IS NULL OR
                                             UPPER("PersonType") IN ('SC', 'VC', 'IN', 'EM', 'SP', 'GC'))
);
...
(
    ...
    "IsOnlyStateProvinceFlag" "Flag"     NOT NULL
        CONSTRAINT "DF_StateProvince_IsOnlyStateProvinceFlag" DEFAULT (true),
    "Name"                    "Name"     NOT NULL,
    "TerritoryID"             INT        NOT NULL,
    "rowguid"                 uuid       NOT NULL
        CONSTRAINT "DF_StateProvince_rowguid"                 DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"            TIMESTAMP  NOT NULL
        CONSTRAINT "DF_StateProvince_ModifiedDate"            DEFAULT (NOW())
);
...
(
    ...
    "rowguid"         uuid        NOT NULL
        CONSTRAINT "DF_Address_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"    TIMESTAMP   NOT NULL
        CONSTRAINT "DF_Address_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "Name"          "Name"    NOT NULL,
    "rowguid"       uuid      NOT NULL
        CONSTRAINT "DF_AddressType_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"  TIMESTAMP NOT NULL
        CONSTRAINT "DF_AddressType_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "rowguid"          uuid      NOT NULL
        CONSTRAINT "DF_BusinessEntityAddress_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_BusinessEntityAddress_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "Name"          "Name"    NOT NULL,
    "ModifiedDate"  TIMESTAMP NOT NULL
        CONSTRAINT "DF_ContactType_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "rowguid"          uuid      NOT NULL
        CONSTRAINT "DF_BusinessEntityContact_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_BusinessEntityContact_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "rowguid"          uuid        NOT NULL
        CONSTRAINT "DF_EmailAddress_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"     TIMESTAMP   NOT NULL
        CONSTRAINT "DF_EmailAddress_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "rowguid"          uuid         NOT NULL
        CONSTRAINT "DF_Password_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    ModifiedDate       TIMESTAMP    NOT NULL
        CONSTRAINT "DF_Password_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "Name"              "Name"    NOT NULL,
    "ModifiedDate"      TIMESTAMP NOT NULL
        CONSTRAINT "DF_PhoneNumberType_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate"      TIMESTAMP NOT NULL
        CONSTRAINT "DF_PersonPhone_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "Name"              "Name"     NOT NULL,
    "ModifiedDate"      TIMESTAMP  NOT NULL
        CONSTRAINT "DF_CountryRegion_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate" TIMESTAMP NOT NULL
        CONSTRAINT "DF_Department_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "SalariedFlag"      "Flag"       NOT NULL
        CONSTRAINT "DF_Employee_SalariedFlag"   DEFAULT (true),
    ...
    "CurrentFlag"       "Flag"       NOT NULL
        CONSTRAINT "DF_Employee_CurrentFlag"    DEFAULT (true),
    "rowguid"           uuid         NOT NULL
        CONSTRAINT "DF_Employee_rowguid"        DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"      TIMESTAMP    NOT NULL
        CONSTRAINT "DF_Employee_ModifiedDate"   DEFAULT (NOW()),
...
(
    ...
    "EndDate"          DATE      NULL,
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_EmployeeDepartmentHistory_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_EmployeePayHistory_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_JobCandidate_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate" TIMESTAMP NOT NULL
        CONSTRAINT "DF_Shift_ModifiedDate" DEFAULT (NOW())
);
...
ALTER TABLE "HumanResources"."Employee"
    ADD organizationnode VARCHAR DEFAULT '/';
-- Convert from all the hex to a stream of hierarchyid bits
WITH RECURSIVE hier AS (SELECT "BusinessEntityID",
                               "Org",
                               get_byte(decode(substring("Org", 1, 2), 'hex'), 0)::bit(8)::varchar AS bits,
                               2                                                                   AS i
                        FROM "HumanResources"."Employee"
                        UNION ALL
                        SELECT e."BusinessEntityID",
                               e."Org",
                               hier.bits || get_byte(decode(substring(e."Org", i + 1, 2), 'hex'), 0)::bit(8)::varchar,
                               i + 2 AS i
...
BEGIN
    LOOP
        ...
        SET organizationnode = organizationnode || SUBSTRING("Org", 3, 2)::bit(2)::INTEGER::VARCHAR ||
                               CASE SUBSTRING("Org", 5, 1) WHEN '0' THEN '.' ELSE '/' END,
        ...
        -- 100 = 4-7
        UPDATE "HumanResources"."Employee"
        SET organizationnode = organizationnode || (SUBSTRING("Org", 4, 2)::bit(2)::INTEGER + 4)::VARCHAR ||
                               CASE SUBSTRING("Org", 6, 1) WHEN '0' THEN '.' ELSE '/' END,
        ...
        -- 101 = 8-15
        UPDATE "HumanResources"."Employee"
        SET organizationnode = organizationnode || (SUBSTRING("Org", 4, 3)::bit(3)::INTEGER + 8)::VARCHAR ||
                               CASE SUBSTRING("Org", 7, 1) WHEN '0' THEN '.' ELSE '/' END,
        ...
        SET organizationnode = organizationnode ||
                               ((SUBSTRING("Org", 4, 2) || SUBSTRING("Org", 7, 1) ||
                                 SUBSTRING("Org", 9, 3))::bit(6)::INTEGER +
                                16)::VARCHAR || CASE SUBSTRING("Org", 12, 1) WHEN '0' THEN '.' ELSE '/' END,
        ...
        UPDATE "HumanResources"."Employee"
        SET organizationnode = organizationnode ||
                               ((SUBSTRING("Org", 5, 3) || SUBSTRING("Org", 9, 3) || SUBSTRING("Org", 13, 1) ||
                                 SUBSTRING("Org", 15, 3))::bit(10)::INTEGER + 80)::VARCHAR ||
                               CASE SUBSTRING("Org", 18, 1) WHEN '0' THEN '.' ELSE '/' END,
...
(
    ...
    "StartDate"         TIMESTAMP     NOT NULL
        CONSTRAINT "DF_BillOfMaterials_StartDate"      DEFAULT (NOW()),
    "EndDate"           TIMESTAMP     NULL,
    "UnitMeasureCode"   char(3)       NOT NULL,
    "BOMLevel"          smallint      NOT NULL,
    "PerAssemblyQty"    decimal(8, 2) NOT NULL
        CONSTRAINT "DF_BillOfMaterials_PerAssemblyQty" DEFAULT (1.00),
    "ModifiedDate"      TIMESTAMP     NOT NULL
        CONSTRAINT "DF_BillOfMaterials_ModifiedDate"   DEFAULT (NOW()),
...
(
    ...
    "Name"         "Name"    NOT NULL,
    "ModifiedDate" TIMESTAMP NOT NULL
        CONSTRAINT "DF_Culture_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "FolderFlag"      "Flag"      NOT NULL
        CONSTRAINT "DF_Document_FolderFlag"   DEFAULT (false),
    "FileName" varchar(400) NOT NULL,
    "FileExtension" varchar(8) NULL,
    "Revision" char(5) NOT NULL,
    "ChangeNumber" INT NOT NULL
        CONSTRAINT "DF_Document_ChangeNumber" DEFAULT (0),
    "Status"          smallint    NOT NULL, -- tinyint
    "DocumentSummary" text        NULL,
    "Document"        bytea       NULL, -- varbinary
    "rowguid"         uuid        NOT NULL UNIQUE
        CONSTRAINT "DF_Document_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"    TIMESTAMP   NOT NULL
        CONSTRAINT "DF_Document_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "Name"              "Name"    NOT NULL,
    "rowguid"           uuid      NOT NULL
        CONSTRAINT "DF_ProductCategory_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"      TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductCategory_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "Name"                 "Name"    NOT NULL,
    "rowguid"              uuid      NOT NULL
        CONSTRAINT "DF_ProductSubcategory_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"         TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductSubcategory_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "rowguid"            uuid      NOT NULL
        CONSTRAINT "DF_ProductModel_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"       TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductModel_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "MakeFlag"              "Flag"        NOT NULL
        CONSTRAINT "DF_Product_MakeFlag"          DEFAULT (true),
    "FinishedGoodsFlag"     "Flag"        NOT NULL
        CONSTRAINT "DF_Product_FinishedGoodsFlag" DEFAULT (true),
    ...
    "rowguid"               uuid          NOT NULL
        CONSTRAINT "DF_Product_rowguid"           DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"          TIMESTAMP     NOT NULL
        CONSTRAINT "DF_Product_ModifiedDate"      DEFAULT (NOW()),
...
(
    ...
    "StandardCost" numeric   NOT NULL, -- money
    "ModifiedDate" TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductCostHistory_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "rowguid"              uuid         NOT NULL
        CONSTRAINT "DF_ProductDescription_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"         TIMESTAMP    NOT NULL
        CONSTRAINT "DF_ProductDescription_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate" TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductDocument_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "CostRate"     numeric       NOT NULL
        CONSTRAINT "DF_Location_CostRate"     DEFAULT (0.00), -- smallmoney -- money
...
(
    ...
    "Quantity"     smallint    NOT NULL
        CONSTRAINT "DF_ProductInventory_Quantity"     DEFAULT (0),
    "rowguid"      uuid        NOT NULL
        CONSTRAINT "DF_ProductInventory_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate" TIMESTAMP   NOT NULL
        CONSTRAINT "DF_ProductInventory_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "ListPrice"    numeric   NOT NULL, -- money
    "ModifiedDate" TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductListPriceHistory_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "Diagram"        XML       NULL,
    "ModifiedDate"   TIMESTAMP NOT NULL
        CONSTRAINT "DF_Illustration_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate"   TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductModelIllustration_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "CultureID"            char(6)   NOT NULL,
    "ModifiedDate"         TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductModelProductDescriptionCulture_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate"           TIMESTAMP   NOT NULL
        CONSTRAINT "DF_ProductPhoto_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "primary"        "Flag"    NOT NULL
        CONSTRAINT "DF_ProductProductPhoto_Primary"      DEFAULT (false),
    "ModifiedDate"   TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductProductPhoto_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ReviewDate"      TIMESTAMP   NOT NULL
        CONSTRAINT "DF_ProductReview_ReviewDate"   DEFAULT (NOW()),
    "EmailAddress"    varchar(50) NOT NULL,
    "Rating"          INT         NOT NULL,
    "Comments"        varchar(3850),
    "ModifiedDate"    TIMESTAMP   NOT NULL
        CONSTRAINT "DF_ProductReview_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "Name"          "Name"    NOT NULL,
    "ModifiedDate"  TIMESTAMP NOT NULL
        CONSTRAINT "DF_ScrapReason_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ReferenceOrderLineID" INT       NOT NULL
        CONSTRAINT "DF_TransactionHistory_ReferenceOrderLineID" DEFAULT (0),
    "TransactionDate"      TIMESTAMP NOT NULL
        CONSTRAINT "DF_TransactionHistory_TransactionDate"      DEFAULT (NOW()),
    "TransactionType"      char(1)   NOT NULL,
    "Quantity"             INT       NOT NULL,
    "ActualCost"           numeric   NOT NULL, -- money
    "ModifiedDate"         TIMESTAMP NOT NULL
        CONSTRAINT "DF_TransactionHistory_ModifiedDate"         DEFAULT (NOW()),
...
(
    ...
    "ReferenceOrderID"     INT       NOT NULL,
    "ReferenceOrderLineID" INT       NOT NULL
        CONSTRAINT "DF_TransactionHistoryArchive_ReferenceOrderLineID" DEFAULT (0),
    "TransactionDate"      TIMESTAMP NOT NULL
        CONSTRAINT "DF_TransactionHistoryArchive_TransactionDate"      DEFAULT (NOW()),
    "TransactionType"      char(1)   NOT NULL,
    "Quantity"             INT       NOT NULL,
    "ActualCost"           numeric   NOT NULL, -- money
    "ModifiedDate"         TIMESTAMP NOT NULL
        CONSTRAINT "DF_TransactionHistoryArchive_ModifiedDate"         DEFAULT (NOW()),
...
(
    ...
    "Name"            "Name"    NOT NULL,
    "ModifiedDate"    TIMESTAMP NOT NULL
        CONSTRAINT "DF_UnitMeasure_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate"  TIMESTAMP NOT NULL
        CONSTRAINT "DF_WorkOrder_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "ModifiedDate"       TIMESTAMP     NOT NULL
        CONSTRAINT "DF_WorkOrderRouting_ModifiedDate" DEFAULT (NOW()),
...
-- so instead ...
INSERT INTO "Production"."ProductReview" ("ProductReviewID", "ProductID", "ReviewerName", "ReviewDate", "EmailAddress",
                                          "Rating",
                                          "Comments", "ModifiedDate")
VALUES (1, 709, 'John Smith', '2013-09-18 00:00:00', 'john@fourthcoffee.com', 5, 'I can''t believe I''m singing the praises of a pair of socks, but I just came back from a grueling
...
ALTER TABLE "Production"."WorkOrder"
    DROP COLUMN "StockedQty";
ALTER TABLE "Production"."Document"
    DROP COLUMN "DocumentLevel";

-- Document HierarchyID column
ALTER TABLE "Production"."Document"
    ADD "DocumentNode" VARCHAR DEFAULT '/';
-- Convert from all the hex to a stream of hierarchyid bits
WITH RECURSIVE hier AS (SELECT rowguid,
                               "Doc",
                               get_byte(decode(substring("Doc", 1, 2), 'hex'), 0)::bit(8)::varchar AS bits,
                               2                                                                   AS i
                        FROM "Production"."Document"
                        UNION ALL
                        SELECT e.rowguid,
                               e."Doc",
                               hier.bits || get_byte(decode(substring(e."Doc", i + 1, 2), 'hex'), 0)::bit(8)::varchar,
                               i + 2 AS i
                        FROM "Production"."Document" AS e
                                 INNER JOIN
...
BEGIN
    LOOP
        ...
        SET "DocumentNode" = "DocumentNode" || SUBSTRING("Doc", 3, 2)::bit(2)::INTEGER::VARCHAR ||
                             CASE SUBSTRING("Doc", 5, 1) WHEN '0' THEN '.' ELSE '/' END,
        ...
        -- 100 = 4-7
        UPDATE "Production"."Document"
        SET "DocumentNode" = "DocumentNode" || (SUBSTRING("Doc", 4, 2)::bit(2)::INTEGER + 4)::VARCHAR ||
                             CASE SUBSTRING("Doc", 6, 1) WHEN '0' THEN '.' ELSE '/' END,
        ...
        -- 101 = 8-15
        UPDATE "Production"."Document"
        SET "DocumentNode" = "DocumentNode" || (SUBSTRING("Doc", 4, 3)::bit(3)::INTEGER + 8)::VARCHAR ||
                             CASE SUBSTRING("Doc", 7, 1) WHEN '0' THEN '.' ELSE '/' END,
        ...
        -- 110 = 16-79
        UPDATE "Production"."Document"
        SET "DocumentNode" = "DocumentNode" ||
                             ((SUBSTRING("Doc", 4, 2) || SUBSTRING("Doc", 7, 1) ||
                               SUBSTRING("Doc", 9, 3))::bit(6)::INTEGER +
                              16)::VARCHAR || CASE SUBSTRING("Doc", 12, 1) WHEN '0' THEN '.' ELSE '/' END,
        ...
        UPDATE "Production"."Document"
        SET "DocumentNode" = "DocumentNode" ||
                             ((SUBSTRING("Doc", 5, 3) || SUBSTRING("Doc", 9, 3) || SUBSTRING("Doc", 13, 1) ||
                               SUBSTRING("Doc", 15, 3))::bit(10)::INTEGER + 80)::VARCHAR ||
                             CASE SUBSTRING("Doc", 18, 1) WHEN '0' THEN '.' ELSE '/' END,
...
ALTER TABLE "Production"."ProductDocument"
    ADD "DocumentNode" VARCHAR DEFAULT '/';
ALTER TABLE "Production"."ProductDocument"
    ADD rowguid uuid NOT NULL
        CONSTRAINT "DF_ProductDocument_rowguid" DEFAULT (gen_random_uuid());
-- Convert from all the hex to a stream of hierarchyid bits
WITH RECURSIVE hier AS (SELECT rowguid,
                               "Doc",
                               get_byte(decode(substring("Doc", 1, 2), 'hex'), 0)::bit(8)::varchar AS bits,
                        ...
                        SELECT e.rowguid,
                               ...
                               hier.bits || get_byte(decode(substring(e."Doc", i + 1, 2), 'hex'), 0)::bit(8)::varchar,
                               i + 2 AS i
                        FROM "Production"."ProductDocument" AS e
                                 INNER JOIN
                             hier ON e.rowguid = hier.rowguid AND i < LENGTH(e."Doc"))
...
(
    ...
    "UnitMeasureCode"  char(3)   NOT NULL,
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_ProductVendor_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "ModifiedDate"          TIMESTAMP     NOT NULL
        CONSTRAINT "DF_PurchaseOrderDetail_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "RevisionNumber"  smallint  NOT NULL
        CONSTRAINT "DF_PurchaseOrderHeader_RevisionNumber" DEFAULT (0),          -- tinyint
    "Status"          smallint  NOT NULL
        CONSTRAINT "DF_PurchaseOrderHeader_Status"         DEFAULT (1),          -- tinyint
    "EmployeeID"      INT       NOT NULL,
    "VendorID"        INT       NOT NULL,
    "ShipMethodID"    INT       NOT NULL,
    "OrderDate"       TIMESTAMP NOT NULL
        CONSTRAINT "DF_PurchaseOrderHeader_OrderDate"      DEFAULT (NOW()),
    "ShipDate"        TIMESTAMP NULL,
    "SubTotal"        numeric   NOT NULL
        CONSTRAINT "DF_PurchaseOrderHeader_SubTotal"       DEFAULT (0.00),       -- money
    "TaxAmt"          numeric   NOT NULL
        CONSTRAINT "DF_PurchaseOrderHeader_TaxAmt"         DEFAULT (0.00),       -- money
    "Freight"         numeric   NOT NULL
        CONSTRAINT "DF_PurchaseOrderHeader_Freight"        DEFAULT (0.00),       -- money
    "TotalDue"        numeric,                                                   -- AS ISNULL(SubTotal + TaxAmt + Freight, 0) PERSISTED NOT NULL,
    "ModifiedDate"    TIMESTAMP NOT NULL
        CONSTRAINT "DF_PurchaseOrderHeader_ModifiedDate"   DEFAULT (NOW()),
...
(
    ...
    "ShipBase"     numeric   NOT NULL
        CONSTRAINT "DF_ShipMethod_ShipBase"     DEFAULT (0.00),              -- money
    "ShipRate"     numeric   NOT NULL
        CONSTRAINT "DF_ShipMethod_ShipRate"     DEFAULT (0.00),              -- money
    "rowguid"      uuid      NOT NULL
        CONSTRAINT "DF_ShipMethod_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate" TIMESTAMP NOT NULL
        CONSTRAINT "DF_ShipMethod_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "PreferredVendorStatus"   "Flag"          NOT NULL
        CONSTRAINT "DF_Vendor_PreferredVendorStatus" DEFAULT (true),
    "ActiveFlag"              "Flag"          NOT NULL
        CONSTRAINT "DF_Vendor_ActiveFlag"            DEFAULT (true),
    "PurchasingWebServiceURL" varchar(1024)   NULL,
    "ModifiedDate"            TIMESTAMP       NOT NULL
        CONSTRAINT "DF_Vendor_ModifiedDate"          DEFAULT (NOW()),
...
(
    ...
    "ModifiedDate"      TIMESTAMP  NOT NULL
        CONSTRAINT "DF_CountryRegionCurrency_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate" TIMESTAMP   NOT NULL
        CONSTRAINT "DF_CreditCard_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "Name"         "Name"    NOT NULL,
    "ModifiedDate" TIMESTAMP NOT NULL
        CONSTRAINT "DF_Currency_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_CurrencyRate_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "rowguid"       uuid      NOT NULL
        CONSTRAINT "DF_Customer_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"  TIMESTAMP NOT NULL
        CONSTRAINT "DF_Customer_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_PersonCreditCard_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "UnitPriceDiscount"     numeric     NOT NULL
        CONSTRAINT "DF_SalesOrderDetail_UnitPriceDiscount" DEFAULT (0.0),               -- money
    "LineTotal"             numeric,                                                    -- AS ISNULL(UnitPrice * (1.0 - UnitPriceDiscount) * OrderQty, 0.0),
    "rowguid"               uuid        NOT NULL
        CONSTRAINT "DF_SalesOrderDetail_rowguid"           DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"          TIMESTAMP   NOT NULL
        CONSTRAINT "DF_SalesOrderDetail_ModifiedDate"      DEFAULT (NOW()),
...
(
    ...
    "RevisionNumber"         smallint        NOT NULL
        CONSTRAINT "DF_SalesOrderHeader_RevisionNumber"  DEFAULT (0),                 -- tinyint
    "OrderDate"              TIMESTAMP       NOT NULL
        CONSTRAINT "DF_SalesOrderHeader_OrderDate"       DEFAULT (NOW()),
    "DueDate"                TIMESTAMP       NOT NULL,
    "ShipDate"               TIMESTAMP       NULL,
    "Status"                 smallint        NOT NULL
        CONSTRAINT "DF_SalesOrderHeader_Status"          DEFAULT (1),                 -- tinyint
    "OnlineOrderFlag"        "Flag"          NOT NULL
        CONSTRAINT "DF_SalesOrderHeader_OnlineOrderFlag" DEFAULT (true),
    ...
    "SubTotal"               numeric         NOT NULL
        CONSTRAINT "DF_SalesOrderHeader_SubTotal"        DEFAULT (0.00),              -- money
    "TaxAmt"                 numeric         NOT NULL
        CONSTRAINT "DF_SalesOrderHeader_TaxAmt"          DEFAULT (0.00),              -- money
    "Freight"                numeric         NOT NULL
        CONSTRAINT "DF_SalesOrderHeader_Freight"         DEFAULT (0.00),              -- money
    "TotalDue"               numeric,                                                 -- AS ISNULL(SubTotal + TaxAmt + Freight, 0),
    "Comment"                varchar(128)    NULL,
    "rowguid"                uuid            NOT NULL
        CONSTRAINT "DF_SalesOrderHeader_rowguid"         DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"           TIMESTAMP       NOT NULL
        CONSTRAINT "DF_SalesOrderHeader_ModifiedDate"    DEFAULT (NOW()),
...
(
    ...
    "ModifiedDate"  TIMESTAMP NOT NULL
        CONSTRAINT "DF_SalesOrderHeaderSalesReason_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "Bonus"            numeric   NOT NULL
        CONSTRAINT "DF_SalesPerson_Bonus"         DEFAULT (0.00),              -- money
    "CommissionPct"    numeric   NOT NULL
        CONSTRAINT "DF_SalesPerson_CommissionPct" DEFAULT (0.00),              -- smallmoney -- money
    "SalesYTD"         numeric   NOT NULL
        CONSTRAINT "DF_SalesPerson_SalesYTD"      DEFAULT (0.00),              -- money
    "SalesLastYear"    numeric   NOT NULL
        CONSTRAINT "DF_SalesPerson_SalesLastYear" DEFAULT (0.00),              -- money
    "rowguid"          uuid      NOT NULL
        CONSTRAINT "DF_SalesPerson_rowguid"       DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_SalesPerson_ModifiedDate"  DEFAULT (NOW()),
...
(
    ...
    "rowguid"          uuid      NOT NULL
        CONSTRAINT "DF_SalesPersonQuotaHistory_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_SalesPersonQuotaHistory_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "ModifiedDate"  TIMESTAMP NOT NULL
        CONSTRAINT "DF_SalesReason_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "TaxRate"         numeric   NOT NULL
        CONSTRAINT "DF_SalesTaxRate_TaxRate"      DEFAULT (0.00),              -- smallmoney -- money
    "Name"            "Name"    NOT NULL,
    "rowguid"         uuid      NOT NULL
        CONSTRAINT "DF_SalesTaxRate_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"    TIMESTAMP NOT NULL
        CONSTRAINT "DF_SalesTaxRate_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "SalesYTD"          numeric     NOT NULL
        CONSTRAINT "DF_SalesTerritory_SalesYTD"      DEFAULT (0.00),              -- money
    "SalesLastYear"     numeric     NOT NULL
        CONSTRAINT "DF_SalesTerritory_SalesLastYear" DEFAULT (0.00),              -- money
    "CostYTD"           numeric     NOT NULL
        CONSTRAINT "DF_SalesTerritory_CostYTD"       DEFAULT (0.00),              -- money
    "CostLastYear"      numeric     NOT NULL
        CONSTRAINT "DF_SalesTerritory_CostLastYear"  DEFAULT (0.00),              -- money
    "rowguid"           uuid        NOT NULL
        CONSTRAINT "DF_SalesTerritory_rowguid"       DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"      TIMESTAMP   NOT NULL
        CONSTRAINT "DF_SalesTerritory_ModifiedDate"  DEFAULT (NOW()),
...
(
    ...
    "EndDate"          TIMESTAMP NULL,
    "rowguid"          uuid      NOT NULL
        CONSTRAINT "DF_SalesTerritoryHistory_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_SalesTerritoryHistory_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "Quantity"           INT         NOT NULL
        CONSTRAINT "DF_ShoppingCartItem_Quantity"     DEFAULT (1),
    "ProductID"          INT         NOT NULL,
    "DateCreated"        TIMESTAMP   NOT NULL
        CONSTRAINT "DF_ShoppingCartItem_DateCreated"  DEFAULT (NOW()),
    "ModifiedDate"       TIMESTAMP   NOT NULL
        CONSTRAINT "DF_ShoppingCartItem_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "DiscountPct"    numeric      NOT NULL
        CONSTRAINT "DF_SpecialOffer_DiscountPct"  DEFAULT (0.00),              -- smallmoney -- money
    "Type"           varchar(50)  NOT NULL,
    "Category"       varchar(50)  NOT NULL,
    "StartDate"      TIMESTAMP    NOT NULL,
    "EndDate"        TIMESTAMP    NOT NULL,
    "MinQty"         INT          NOT NULL
        CONSTRAINT "DF_SpecialOffer_MinQty"       DEFAULT (0),
    "MaxQty"         INT          NULL,
    "rowguid"        uuid         NOT NULL
        CONSTRAINT "DF_SpecialOffer_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"   TIMESTAMP    NOT NULL
        CONSTRAINT "DF_SpecialOffer_ModifiedDate" DEFAULT (NOW()),
...
(
    ...
    "ProductID"      INT       NOT NULL,
    "rowguid"        uuid      NOT NULL
        CONSTRAINT "DF_SpecialOfferProduct_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"   TIMESTAMP NOT NULL
        CONSTRAINT "DF_SpecialOfferProduct_ModifiedDate" DEFAULT (NOW())
);
...
(
    ...
    "rowguid"          uuid      NOT NULL
        CONSTRAINT "DF_Store_rowguid"      DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    "ModifiedDate"     TIMESTAMP NOT NULL
        CONSTRAINT "DF_Store_ModifiedDate" DEFAULT (NOW())
);
...
SELECT p."BusinessEntityID"
     ...
     , p."MiddleName"
     , p."LastName"
     , (xpath('(act:telephoneNumber)[1]/act:number/text()', node,
              '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]
    AS TelephoneNumber
     , BTRIM(
        (xpath('(act:telephoneNumber)[1]/act:SpecialInstructions/text()', node,
               '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]::VARCHAR)
    AS TelephoneSpecialInstructions
     , (xpath('(act:homePostalAddress)[1]/act:Street/text()', node,
              '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]
    AS Street
     , (xpath('(act:homePostalAddress)[1]/act:City/text()', node,
              '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]
    AS City
     , (xpath('(act:homePostalAddress)[1]/act:StateProvince/text()', node,
              '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]
    AS StateProvince
     , (xpath('(act:homePostalAddress)[1]/act:PostalCode/text()', node,
              '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]
    AS PostalCode
     , (xpath('(act:homePostalAddress)[1]/act:CountryRegion/text()', node,
              '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]
    AS CountryRegion
     , (xpath('(act:homePostalAddress)[1]/act:SpecialInstructions/text()', node,
              '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]
    AS HomeAddressSpecialInstructions
     , (xpath('(act:eMail)[1]/act:eMailAddress/text()', node,
              '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]
    AS EMailAddress
     , BTRIM(
        (xpath('(act:eMail)[1]/act:SpecialInstructions/text()', node,
               '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]::VARCHAR)
    AS EMailSpecialInstructions
     , (xpath('((act:eMail)[1]/act:SpecialInstructions/act:telephoneNumber)[1]/act:number/text()', node,
              '{{act,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactTypes}}'))[1]
...
AS
SELECT "BusinessEntityID"
     , CAST((xpath('n:TotalPurchaseYTD/text()', "Demographics",
                   '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR AS money)
    AS "TotalPurchaseYTD"
     , CAST((xpath('n:DateFirstPurchase/text()', "Demographics",
                   '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR AS DATE)
    AS "DateFirstPurchase"
     , CAST((xpath('n:BirthDate/text()', "Demographics",
                   '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR AS DATE)
    AS "BirthDate"
     , (xpath('n:MaritalStatus/text()', "Demographics",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR(1)
    AS "MaritalStatus"
     , (xpath('n:YearlyIncome/text()', "Demographics",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR(30)
    AS "YearlyIncome"
     , (xpath('n:Gender/text()', "Demographics",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR(1)
    AS "Gender"
     , CAST((xpath('n:TotalChildren/text()', "Demographics",
                   '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR AS INTEGER)
    AS "TotalChildren"
     , CAST((xpath('n:NumberChildrenAtHome/text()', "Demographics",
                   '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR AS INTEGER)
    AS "NumberChildrenAtHome"
     , (xpath('n:Education/text()', "Demographics",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR(30)
    AS "Education"
     , (xpath('n:Occupation/text()', "Demographics",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR(30)
    AS "Occupation"
     , CAST((xpath('n:HomeOwnerFlag/text()', "Demographics",
                   '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR AS BOOLEAN)
    AS "HomeOwnerFlag"
     , CAST((xpath('n:NumberCarsOwned/text()', "Demographics",
                   '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey}}'))[1]::VARCHAR AS INTEGER)
    AS "NumberCarsOwned"
FROM "Person"."Person"
...
SELECT "JobCandidateID"
     , "BusinessEntityID"
     , (xpath('/n:Resume/n:Name/n:Name.Prefix/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(30)
    AS "Name.Prefix"
     , (xpath('/n:Resume/n:Name/n:Name.First/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(30)
    AS "Name.First"
     , (xpath('/n:Resume/n:Name/n:Name.Middle/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(30)
    AS "Name.Middle"
     , (xpath('/n:Resume/n:Name/n:Name.Last/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(30)
    AS "Name.Last"
     , (xpath('/n:Resume/n:Name/n:Name.Suffix/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(30)
    AS "Name.Suffix"
     , (xpath('/n:Resume/n:Skills/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar
    AS "Skills"
     , (xpath('n:Address/n:Addr.Type/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(30)
    AS "Addr.Type"
     , (xpath('n:Address/n:Addr.Location/n:Location/n:Loc.CountryRegion/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(100)
    AS "Addr.Loc.CountryRegion"
     , (xpath('n:Address/n:Addr.Location/n:Location/n:Loc.State/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(100)
    AS "Addr.Loc.State"
     , (xpath('n:Address/n:Addr.Location/n:Location/n:Loc.City/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(100)
    AS "Addr.Loc.City"
     , (xpath('n:Address/n:Addr.PostalCode/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar(20)
    AS "Addr.PostalCode"
     , (xpath('/n:Resume/n:EMail/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar
    AS "EMail"
     , (xpath('/n:Resume/n:WebSite/text()', "Resume",
              '{{n,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))[1]::varchar
    AS "WebSite"
     , "ModifiedDate"
...
AS
SELECT "JobCandidateID"
     , CAST(UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.StartDate/text()', "Resume",
                         '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::VARCHAR(20) AS DATE)
    AS "Emp.StartDate"
     , CAST(UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.EndDate/text()', "Resume",
                         '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::VARCHAR(20) AS DATE)
    AS "Emp.EndDate"
     , UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.OrgName/text()', "Resume",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::varchar(100)
    AS "Emp.OrgName"
     , UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.JobTitle/text()', "Resume",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::varchar(100)
    AS "Emp.JobTitle"
     , UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.Responsibility/text()', "Resume",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::varchar
    AS "Emp.Responsibility"
     , UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.FunctionCategory/text()', "Resume",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::varchar
    AS "Emp.FunctionCategory"
     , UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.IndustryCategory/text()', "Resume",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::varchar
    AS "Emp.IndustryCategory"
     , UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.Location/ns:Location/ns:Loc.CountryRegion/text()', "Resume",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::varchar
    AS "Emp.Loc.CountryRegion"
     , UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.Location/ns:Location/ns:Loc.State/text()', "Resume",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::varchar
    AS "Emp.Loc.State"
     , UNNEST(xpath('/ns:Resume/ns:Employment/ns:Emp.Location/ns:Location/ns:Loc.City/text()', "Resume",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}'))::varchar
    AS "Emp.Loc.City"
FROM "HumanResources"."JobCandidate";
...
SELECT jc."JobCandidateID"
    ...
    AS "Edu.Level"
     , CAST((xpath('/root/ns:Education/ns:Edu.StartDate/text()', jc.doc,
                   '{{ns,http://adventureworks.com}}'))[1]::VARCHAR(20) AS DATE)
    AS "Edu.StartDate"
     , CAST((xpath('/root/ns:Education/ns:Edu.EndDate/text()', jc.doc,
                   '{{ns,http://adventureworks.com}}'))[1]::VARCHAR(20) AS DATE)
    AS "Edu.EndDate"
    ...
    AS "Edu.School"
     , (xpath('/root/ns:Education/ns:Edu.Location/ns:Location/ns:Loc.CountryRegion/text()', jc.doc,
              '{{ns,http://adventureworks.com}}'))[1]::varchar(100)
    AS "Edu.Loc.CountryRegion"
     , (xpath('/root/ns:Education/ns:Edu.Location/ns:Location/ns:Loc.State/text()', jc.doc,
              '{{ns,http://adventureworks.com}}'))[1]::varchar(100)
    AS "Edu.Loc.State"
     , (xpath('/root/ns:Education/ns:Edu.Location/ns:Location/ns:Loc.City/text()', jc.doc,
              '{{ns,http://adventureworks.com}}'))[1]::varchar(100)
    AS "Edu.Loc.City"
FROM (SELECT "JobCandidateID"
           ...
           , ('<root xmlns:ns="http://adventureworks.com">' ||
              ...
              '</root>')::xml AS doc
      FROM (SELECT "JobCandidateID"
                 , UNNEST(xpath('/ns:Resume/ns:Education', "Resume",
                                '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume}}')) AS "Education"
...
SELECT "ProductModelID"
     , "Name"
     , (xpath('/p1:ProductDescription/p1:Summary/html:p/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{html,http://www.w3.org/1999/xhtml}}'))[1]::varchar
    AS "Summary"
     , (xpath('/p1:ProductDescription/p1:Manufacturer/p1:Name/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar
    AS Manufacturer
     , (xpath('/p1:ProductDescription/p1:Manufacturer/p1:Copyright/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(30)
    AS Copyright
     , (xpath('/p1:ProductDescription/p1:Manufacturer/p1:ProductURL/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(256)
    AS ProductURL
     , (xpath('/p1:ProductDescription/p1:Features/wm:Warranty/wm:WarrantyPeriod/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{wm,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelWarrAndMain}}'))[1]::varchar(256)
    AS WarrantyPeriod
     , (xpath('/p1:ProductDescription/p1:Features/wm:Warranty/wm:Description/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{wm,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelWarrAndMain}}'))[1]::varchar(256)
    AS WarrantyDescription
     , (xpath('/p1:ProductDescription/p1:Features/wm:Maintenance/wm:NoOfYears/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{wm,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelWarrAndMain}}'))[1]::varchar(256)
    AS NoOfYears
     , (xpath('/p1:ProductDescription/p1:Features/wm:Maintenance/wm:Description/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{wm,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelWarrAndMain}}'))[1]::varchar(256)
    AS MaintenanceDescription
     , (xpath('/p1:ProductDescription/p1:Features/wf:wheel/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{wf,http://www.adventure-works.com/schemas/OtherFeatures}}'))[1]::varchar(256)
    AS Wheel
     , (xpath('/p1:ProductDescription/p1:Features/wf:saddle/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{wf,http://www.adventure-works.com/schemas/OtherFeatures}}'))[1]::varchar(256)
    AS Saddle
     , (xpath('/p1:ProductDescription/p1:Features/wf:pedal/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{wf,http://www.adventure-works.com/schemas/OtherFeatures}}'))[1]::varchar(256)
    AS Pedal
     , (xpath('/p1:ProductDescription/p1:Features/wf:BikeFrame/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{wf,http://www.adventure-works.com/schemas/OtherFeatures}}'))[1]::varchar
    AS BikeFrame
     , (xpath('/p1:ProductDescription/p1:Features/wf:crankset/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription},{wf,http://www.adventure-works.com/schemas/OtherFeatures}}'))[1]::varchar(256)
    AS Crankset
     , (xpath('/p1:ProductDescription/p1:Picture/p1:Angle/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(256)
    AS PictureAngle
     , (xpath('/p1:ProductDescription/p1:Picture/p1:Size/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(256)
    AS PictureSize
     , (xpath('/p1:ProductDescription/p1:Picture/p1:ProductPhotoID/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(256)
    AS ProductPhotoID
     , (xpath('/p1:ProductDescription/p1:Specifications/Material/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(256)
    AS Material
     , (xpath('/p1:ProductDescription/p1:Specifications/Color/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(256)
    AS Color
     , (xpath('/p1:ProductDescription/p1:Specifications/ProductLine/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(256)
    AS ProductLine
     , (xpath('/p1:ProductDescription/p1:Specifications/Style/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(256)
    AS Style
     , (xpath('/p1:ProductDescription/p1:Specifications/RiderExperience/text()', "CatalogDescription",
              '{{p1,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelDescription}}'))[1]::varchar(1024)
    AS "RiderExperience"
     , "rowguid"
     , "ModifiedDate"
...
SELECT pm."ProductModelID"
     ...
     , (xpath('/ns:root/text()', pm."Instructions",
              '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelManuInstructions}}'))[1]::varchar AS "Instructions"
...
FROM (SELECT locations."ProductModelID"
      ...
      FROM (SELECT
                ...
                "ProductModelID"
                 ...
                 , UNNEST(xpath('/ns:root/ns:Location', "Instructions",
                                '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelManuInstructions}}')) AS "MfgInstructions"
...
(SELECT soh."SalesPersonID"
 ...
 FROM "Sales"."SalesPerson" sp
          ...
          INNER JOIN "Person"."Person" p
                     ON p."BusinessEntityID" = sp."BusinessEntityID") AS granular
...
SELECT "BusinessEntityID"
     , "Name"
     , CAST(UNNEST(xpath('/ns:StoreSurvey/ns:AnnualSales/text()', "Demographics",
                         '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar AS money)
    AS "AnnualSales"
     , CAST(UNNEST(xpath('/ns:StoreSurvey/ns:AnnualRevenue/text()', "Demographics",
                         '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar AS money)
    AS "AnnualRevenue"
     , UNNEST(xpath('/ns:StoreSurvey/ns:BankName/text()', "Demographics",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar(50)
    AS "BankName"
     , UNNEST(xpath('/ns:StoreSurvey/ns:BusinessType/text()', "Demographics",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar(5)
    AS "BusinessType"
     , CAST(UNNEST(xpath('/ns:StoreSurvey/ns:YearOpened/text()', "Demographics",
                         '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar AS integer)
    AS "YearOpened"
     , UNNEST(xpath('/ns:StoreSurvey/ns:Specialty/text()', "Demographics",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar(50)
    AS "Specialty"
     , CAST(UNNEST(xpath('/ns:StoreSurvey/ns:SquareFeet/text()', "Demographics",
                         '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar AS integer)
    AS "SquareFeet"
     , UNNEST(xpath('/ns:StoreSurvey/ns:Brands/text()', "Demographics",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar(30)
    AS "Brands"
     , UNNEST(xpath('/ns:StoreSurvey/ns:Internet/text()', "Demographics",
                    '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar(30)
    AS "Internet"
     , CAST(UNNEST(xpath('/ns:StoreSurvey/ns:NumberEmployees/text()', "Demographics",
                         '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/StoreSurvey}}'))::varchar AS integer)
    AS "NumberEmployees"
FROM "Sales"."Store";
